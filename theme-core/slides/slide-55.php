                ...
                <div class="fix-6-12 box-55">
                    <div class="pad shadow selected ae-3">
                        <form id="contact-form" action="ajax-email.php" method="post" class="wide center">
                            ...
                            <input class="button wide pink round uppercase ae-10 button-55" type="submit" name="submit" value="Send message" data-success-text="Done!" data-success-class="green"/>
                        </form>
                    </div>
                </div>
