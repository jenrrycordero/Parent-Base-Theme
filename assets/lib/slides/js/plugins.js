...
//redraw
jQuery.fn.redraw = function(){jQuery(this).each(function(){var redraw = this.offsetHeight;});};
...
+function ($) { "use strict";
  ...
  Zoom.prototype._zoomOriginal = function () {
    ...
    jQuery(this._targetImage).parent().closest('[data-action="zoom"]').addClass('zoom-img-parent');
    ...
    /* jQuery(this._targetImage).closest('.wrap').prepend(this._overlay) */
    jQuery(this._targetImageWrap).before(this._overlay)
  ...
  Zoom.prototype._triggerAnimation = function () {
    ...
    var imageOffset = jQuery(this._targetImage).offset()
    ...
    jQuery(this._targetImage).css('transform', 'scale3d(' + this._imgScaleFactor + ',' + this._imgScaleFactor + ',1)')
  ...
  Zoom.prototype.close = function () {
    ...
    jQuery(this._targetImage)
      .one(jQuery.support.transition.end, jQuery.proxy(this.dispose, this))
