...
class acf_location_nav_menu extends acf_location
{
	...
	*/
	...
	function __construct()
	{
		...
		wp_register_style( 'acf-location-nav-menu', get_stylesheet_directory_uri().'/acf-location-nav-menu/css/acf-location-nav-menu.css' );
		wp_register_script( 'google-map-fix-randering', get_stylesheet_directory_uri().'/acf-location-nav-menu/js/google.map.fix.randering.js', array( 'jquery' ) );
		wp_register_script( 'acf-setup-fields-in-right-level', get_stylesheet_directory_uri().'/acf-location-nav-menu/js/acf.setup.fields.in.right.level.js', array( 'jquery' ) );
